        ...
        <div id="pdf-content">
            ...
            <header class="flex flex-col md:flex-row gap-8 items-center mb-16 section-header">
                <div class="w-40 h-40 rounded-full overflow-hidden border-4 border-white shadow-xl">
                    <img src="./img/profile02.png" alt="Profile" class="w-full h-full object-cover">
                </div>
                <div class="flex-1 text-center md:text-left">
                    ...
                    <div class="flex flex-wrap justify-center md:justify-start gap-4 header-contact">
                        <a href="tel:0123456789" class="px-4 py-2 bg-dark text-white rounded-full flex items-center gap-2 hover:bg-gray-600 transition">
                        ...
                        <a href="mailto:monkey.dluffy@email.co.th" class="px-4 py-2 bg-primary text-white rounded-full flex items-center gap-2 hover:bg-blue-600 transition">
                            <!-- <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
